(function ()
{
    ...
    function config($stateProvider, $translatePartialLoaderProvider, msNavigationServiceProvider)
    {
        ...
        $stateProvider.state('app.pages_auth_login-v2', {
            ...
            views    : {
                'main@'                          : {
                    templateUrl: 'app/modules/core/layouts/content-only.html',
                    controller : 'MainController as vm'
                },
                'content@app.pages_auth_login-v2': {
                    templateUrl: 'app/modules/pages/auth/login-v2/login-v2.html',
        ...
        // Translation
        $translatePartialLoaderProvider.addPart('app/modules/pages/auth/login-v2');
